...
const herVowTitle = weddingConfig.highlights?.personalVows.her.title
const hisVowTitle = weddingConfig.highlights?.personalVows.his.title
const herVowDescription = weddingConfig.highlights?.personalVows.her.description
const hisVowDescription = weddingConfig.highlights?.personalVows.his.description
</script>
